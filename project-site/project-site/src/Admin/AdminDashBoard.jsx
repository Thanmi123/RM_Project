        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
              ...
              <ul class="collapse" id="Teacher-submenu">
                ...
                <li class="nav-item">
                  {/* <a class="nav-link text-white" href="#"> */}
                    <Link to="/Admin-DashBoard/attendences-sheet" ><a class="nav-link text-white">Attendance</a></Link>
                </li>
                <li class="nav-item">
                  <Link to="/Admin-DashBoard/generate-tattendeces-report" ><a class="nav-link text-white" href="#">Generate Attendence Report</a></Link>
                </li>
                <li class="nav-item">
                  <Link to="/Admin-DashBoard/view-teachers"><a class="nav-link text-white" href="#">Get all Teacher</a></Link>
          ...
          <div class="nav-item">
              ...
              <ul class="collapse" id="billing-submenu">
                <li class="nav-item"><Link to ="/Admin-DashBoard/add-students">
                  <a class="nav-link text-white" href="#">Registration</a></Link>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="#">Attandance</a>
                </li>
                <li class="nav-item">
                  <Link to="/Admin-DashBoard/view-students"> <a class="nav-link text-white" href="#">Get all Student</a></Link>
